...
PARAMETER_DESCRIPTIONS = {
    ...
    "log_channel": "Private channel that receives ticket transcripts and events.",
    ...
    "spam_messages": "Messages required to trigger spam enforcement, from 3 to 20.",
    "spam_window_seconds": "Spam measurement window, from 3 to 60 seconds.",
    ...
    "timeout_minutes": "AutoMod timeout length; use 0 to delete and warn only.",
    "title": "Short descriptive title.",
    "profanity_threshold": "Perspective score required for enforcement, from 0.1 to 1.0.",
